...
# ──────────────────────────── 目标网站 ────────────────────────────────────────
POKEMON_APPOINTMENT_URL = "https://www.pokemoncenter-online.com/lottery/apply.html"  # 直接打开此页，会自动跳转登录，登录后自动返回
MYPAGE_URL              = "https://www.pokemoncenter-online.com/mypage/"             # 我的账号页（含退出按钮）
...
# 本地调试页面基准路径（所有本地测试页 URL 均由此拼接）
_TESTPAGES_BASE = "file:///C:/Users/YY/Desktop/autopokemon/testpages/"
